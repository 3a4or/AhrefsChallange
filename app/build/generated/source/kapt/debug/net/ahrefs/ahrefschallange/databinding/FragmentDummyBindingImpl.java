...
public class FragmentDummyBindingImpl extends FragmentDummyBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_search_word, 1);
        sViewsWithIds.put(R.id.btn_open_search, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((net.ahrefs.ahrefschallange.ui.dummy.DummyViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable net.ahrefs.ahrefschallange.ui.dummy.DummyViewModel ViewModel) {
