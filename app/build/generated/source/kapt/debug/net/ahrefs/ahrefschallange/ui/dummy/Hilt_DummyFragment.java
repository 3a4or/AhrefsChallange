 ...
 */
public abstract class Hilt_DummyFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DummyFragment_GeneratedInjector) this.generatedComponent()).injectDummyFragment(UnsafeCasts.<DummyFragment>unsafeCast(this));
    }
  }
